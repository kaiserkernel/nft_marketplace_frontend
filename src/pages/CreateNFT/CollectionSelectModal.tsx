...
interface CollectionShowModalProps {
  ...
  setConfirmedCollectionAddress: React.Dispatch<
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 bg-black p-3 rounded-md">
        <span className="text-white font-semibold text-md mb-2">Name :</span>
      ...
      <div className="py-4">
        <img
          ...
          className="rounded-lg w-auto h-auto aspect-square object-cover"
        />
      </div>
      {/* symbol */}
      <div className="mt-4 bg-black p-3 rounded-md">
        <span className="text-white font-semibold text-md mb-2">Symbol :</span>
        <span className="text-white ps-3">{symbol}</span>
      </div>
      <div className="mt-4 bg-black p-3 rounded-md">
        <p className="text-white font-semibold text-md mb-2">Description :</p>
        <p className="text-white ps-3">{description}</p>
      </div>
      <div className="mt-4 p-3 bg-black rounded-md">
        <span className="text-white font-semibold text-md mb-2">Created :</span>
